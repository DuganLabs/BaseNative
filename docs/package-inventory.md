...
| `@basenative/builder` | 0.1.4 | 0.1.3 | — | unreleased bump |
| `@basenative/claude-config` | 0.2.1 | 0.2.1 | — | in sync |
| `@basenative/cli` | 0.4.1 | 0.4.1 | 0.2.0 | in sync |
| `@basenative/combobox` | 1.0.4 | 1.0.3 | — | unreleased bump |
| `@basenative/components` | 0.6.2 | 0.6.1 | 0.3.0 | unreleased bump |
...
| `@basenative/persist` | 1.0.4 | 1.0.3 | — | unreleased bump |
| `@basenative/realtime` | 0.3.0 | 0.3.0 | 0.2.0 | in sync |
| `@basenative/router` | 0.5.0 | 0.4.4 | 0.3.0 | unreleased bump |
| `@basenative/runtime` | 0.6.2 | 0.6.1 | 0.3.0 | unreleased bump |
